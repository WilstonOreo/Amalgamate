...
namespace amalgamate 
{
	...
	static set<ParameterTableElement>& parameterTable()
	{
		...
		if (table.empty())
		{
			...
			ADD("MOSAIC_SIZE","300x300%")
			ADD("MOSAIC_BLENDFACTOR","0.25")
			ADD("MOSAIC_FILENAME","mosaic.jpg")
			ADD("FILTER_HISTSMALL_MATCHES","1000")
			ADD("FILTER_HISTLARGE_MATCHES","100")
			ADD("FILTER_GIST_MATCHES","50")
			ADD("FILTER_THUMBNAIL_MATCHES","50")
			ADD("THUMBNAIL_MATCH_BORDER","0.1667")
			ADD("PANORAMA_BORDER","0.1667")
			ADD("TILEGEN","regular")
